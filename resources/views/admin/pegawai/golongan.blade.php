				...
				<div class="card">
					<div class="card-header">
						<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalAdd"><i
								class="bx bx-plus-circle"></i> Tambah Golongan</button>
					</div>
					<div class="card-body">
		...
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="modalAddTitle">Tambah Golongan</h5>
					...
					<div class="modal-body">
						<div class="row">
							<div class="col-12">
								...
								<input type="text" id="nama_golongan" name="nama_golongan" class="form-control" required>
							</div>
							<div class="col-12">
							...
							<div class="row">
								<div class="col-12">
									<div class="alert alert-danger" role="alert">
										<h4 class="alert-heading">Apakah anda yakin ingin menghapus data golongan</h4>
										<p><strong>{{ $item->nama_golongan }}</strong> ?</p>
										<hr>
									</div>
								</div>
							</div>
